...
export type FormFieldType = 'short_text' | 'long_text' | 'checkbox' | 'checkbox_group' | 'dropdown' | 'date' | 'number' | 'section_header' | 'signature' | 'checklist_placeholder' | 'material_system_placeholder'
