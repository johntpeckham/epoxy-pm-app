 ...
 *  3. Inventory price check requests — same pattern as stock checks, linked
 *     via inventory_products.price_check_task_id. On completion we set
 *     price_check_date = now and clear the link.
 */
