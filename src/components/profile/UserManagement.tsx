...
export default function UserManagement({ currentUserId }: { currentUserId: string }) {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-6 mb-6">
      ...
      {editingUser && (
        <Portal>
        <div className="fixed inset-0 z-[60] overflow-hidden flex flex-col md:items-center md:justify-center bg-black/50 modal-below-header" onClick={closeEditModal}>
