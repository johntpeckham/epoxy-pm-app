...
export default function ConfirmDialog({
  ...
  return (
    <Portal>
    <div className="fixed inset-0 z-[60] overflow-x-hidden max-w-[100vw] flex items-center justify-center p-4 bg-black/50">
      <div className="bg-white rounded-xl shadow-xl max-w-sm w-full p-6" style={{ paddingTop: 'env(safe-area-inset-top, 20px)' }}>
