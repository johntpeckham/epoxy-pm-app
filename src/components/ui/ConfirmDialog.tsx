...
export default function ConfirmDialog({
  ...
  return (
    <Portal>
    <div className="fixed inset-0 z-[60] overflow-hidden flex flex-col md:items-center md:justify-center bg-black/50 modal-below-header" onClick={onCancel}>
      <div className="mt-auto md:mt-0 md:mx-auto w-full md:max-w-2xl h-full md:h-auto md:max-h-[90vh] bg-white md:rounded-xl flex flex-col overflow-hidden" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex-none flex gap-3 justify-end p-4 md:pb-6 border-t" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
          <button
            onClick={onCancel}
            disabled={loading}
