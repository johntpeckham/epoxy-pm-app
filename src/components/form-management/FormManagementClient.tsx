    ...
    <div className="min-h-screen bg-gray-50">
      <div className="flex items-center justify-between px-4 sm:px-6 pt-4 pb-2">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white truncate">Form Management</h1>
        </div>
      </div>
      <div className="max-w-6xl mx-auto px-4 py-8">
        <p className="text-sm text-gray-500 mb-6">Customize form fields and layout for each app form.</p>
        {content}
      </div>
    </div>
  )
