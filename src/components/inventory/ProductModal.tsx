...
import type { InventoryProduct, InventoryUnit } from '@/types'

interface Props {
  product: InventoryProduct | null
  supplierName: string
  onClose: () => void
  onSave: (data: { name: string; quantity: number; unit: InventoryUnit }) => Promise<void> | void
}

export default function ProductModal({ product, supplierName, onClose, onSave }: Props) {
  ...
  async function handleSubmit(e?: React.FormEvent) {
    ...
    setSaving(true)
    try {
      await onSave({ name: trimmed, quantity: parsedQty, unit })
    } catch (err) {
