...
export default function NewReceiptModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center sm:px-4 sm:pb-6" style={{ paddingTop: 'env(safe-area-inset-top, 0px)' }}>
      <div className="absolute inset-0 bg-black/60" onClick={onClose} />
      <div className="relative bg-white rounded-t-2xl sm:rounded-xl shadow-2xl w-full max-w-lg flex flex-col h-[100dvh] sm:h-auto sm:max-h-[90vh]" style={{ paddingTop: 'env(safe-area-inset-top, 0px)' }}>
