  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 bg-gray-50">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        {/* ── Inventory Management Card (placeholder, left column below Employees) ── */}
        <div className="bg-white rounded-xl border border-gray-200 p-4 col-span-2 md:col-span-4 lg:col-span-2 lg:col-start-1 transition-all hover:shadow-sm hover:border-gray-300">
          {/* Card header */}
          <div className="flex items-center gap-2 mb-3">
            <span className="text-amber-500">
              <PackageIcon className="w-5 h-5" />
            </span>
            <h3 className="text-sm font-semibold text-gray-900 flex-1">Inventory Management</h3>
          </div>

          <p className="text-sm text-gray-400">Coming soon — track materials, quantities, and supplier info.</p>
        </div>
