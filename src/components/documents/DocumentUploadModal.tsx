  ...
  return (
    <div className="fixed inset-x-0 bottom-0 modal-top z-50 flex items-center justify-center px-4 py-6">
      ...
      {previewDoc && isPdf(previewDoc) && (
        <div className="fixed inset-x-0 bottom-0 modal-top z-50 bg-black flex flex-col">
      ...
      {previewDoc && !isPdf(previewDoc) && (
        <div className="fixed inset-x-0 bottom-0 modal-top z-[60] flex items-center justify-center lg:p-6">
