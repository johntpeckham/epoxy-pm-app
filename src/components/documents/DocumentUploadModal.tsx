  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4 pt-20 md:pt-6 pb-6">
      ...
      {previewDoc && isPdf(previewDoc) && (
        <div className="fixed inset-0 z-50 bg-black flex flex-col pt-20 md:pt-0">
      ...
      {previewDoc && !isPdf(previewDoc) && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center pt-20 md:pt-0 lg:p-6">
