...
function InlinePhotoPost({ content, onImageClick }: { content: PhotoContent; onImageClick: (urls: string[], index: number) => void }) {
  ...
  return (
    <div className="mt-1 space-y-1.5 w-full">
      ...
      <div className="grid [grid-template-columns:repeat(5,82px)] md:[grid-template-columns:repeat(5,minmax(120px,1fr))] gap-1 md:gap-2 overflow-x-auto md:overflow-visible w-full">
        {urls.map((url, i) => (
