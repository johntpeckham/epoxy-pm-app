...
function InlinePdfPost({ content }: { content: PdfContent }) {
  ...
  return (
    <>
      ...
      {showPreview && (
        <Portal>
        <div className="fixed inset-0 z-[70] overflow-hidden flex flex-col md:items-center md:justify-center bg-black/50 modal-below-header" onClick={() => setShowPreview(false)}>
