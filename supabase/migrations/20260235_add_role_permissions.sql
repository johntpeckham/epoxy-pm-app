...
create table if not exists role_permissions (
  ...
  role text not null check (role in ('salesman', 'office_manager', 'foreman', 'crew')),
...
insert into role_permissions (role, feature, access_level) values
  ...
  ('office_manager', 'jobs', 'full'),
  ('office_manager', 'daily_reports', 'full'),
  ('office_manager', 'jsa_reports', 'full'),
  ('office_manager', 'receipts', 'full'),
  ('office_manager', 'timesheets', 'full'),
  ('office_manager', 'photos', 'full'),
  ('office_manager', 'tasks', 'full'),
  ('office_manager', 'calendar', 'full'),
  ('office_manager', 'project_reports', 'full'),
  ('foreman', 'jobs', 'full'),
